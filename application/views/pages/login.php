...
<div style="margin:200px">
    <div align="center">
        ...
        <form action="<?=base_url("index.php/pages/login");?>" id="form1"  method="post">
            <div><label id="heig"><input type="email" id="account" name="email"  placeholder="Email" ></label></div>
        ...
        <!-- <div><label id="heig"><input type="text" id="Newname" name="Newname"  placeholder="Username" ></label></div> -->
        <div><label id="heig"><input type="email" id="Newaccount" name="Newemail" placeholder="Email" ></label></div>
        <div><label id="heig"><input type="password"  id="Newpassword" name="Newpassword" placeholder="Password" ></label></div>
